...
//https://www.openstreetmap.org/#map=2/48.5972/2.4215
///////////////////////////////////////////////////////////////////////////////////////
...
namespace Test_1
{
    public partial class Scherm_1 : Form
    {
        ...
        public Scherm_1()
        {
            ...
            webBrowser1.Navigate("https://satellites.pro/France_map#48.809641,2.518616,9"); 
        ...
        private void Timer2_Tick(object sender, EventArgs e)
        {
            ...
            if (first_receive == 1)
            {
                ...
                if (battery_bar_level > 124) battery_bar_level = 124; //Erreur
